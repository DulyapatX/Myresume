...
export default function AuroraBackground(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      const currentProps = propsRef.current as any
      program!.uniforms.uTime.value = (t * 0.01 * (currentProps.speed ?? speed) * 0.1)
  ...
  return <div ref={containerRef} className="aurora-root" aria-hidden />
}
